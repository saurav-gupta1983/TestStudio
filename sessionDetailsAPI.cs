...
namespace TS_AutomationStudio.Test_Cases_PROD_Environment
{
    class sessionDetailsAPI
    {
        ...
        static string WebServiceAPI = APICollection.sessionDetails.ToString();
        ...
        public void sessionDetails(Logger loggerObj, string[] OptionalParams)
        {
            Console.WriteLine("\n" + DateTime.Now + " : " + "|> sessionDetails");

            sessionDetailsAPI.loggerObj = loggerObj;
            ...
            try
            {
                if (StudioHome.isPerformanceSuiteRunning)
                {
                    ...
                    filePaths = Directory.GetFiles(TS_AutomationStudio.Resources.sessionDetails.InputFilesLocation + userNo, "*.xml");
                ...
                {
                    filePaths = Directory.GetFiles(TS_AutomationStudio.Resources.sessionDetails.InputFilesLocation, "*.xml");
            ...
            {
                Console.WriteLine("\nSEVERE ERROR : Input Files Location : " + TS_AutomationStudio.Resources.sessionDetails.InputFilesLocation + " does not exist !");
                return;
            }
            ...
            foreach (string  file in filePaths)
            {
                ...
                TS_AutomationStudio.TSWSRef_PROD_Environment.sessionDetails logObj = new TS_AutomationStudio.TSWSRef_PROD_Environment.sessionDetails();
                ...
                sessionDetailsResponse1 lres = null;

                try
                {
                    lres = port.sessionDetails(lr);
                }
                catch (Exception ex)
                {
                    Result = "Fail";
                ...
                WebService_Response_Dump = lres.sessionDetailsResponse.@return;
